...
def lambda_handler(event, context):
    ...
    sender = "hr@tarezameenfoundation.org"
    password = "year@1133"
    s3_path = "s3://tarezameenservices/re_apply/"
    html_file = "rejoin.html"
    ...
    name = event["name"]
    email = event["email"]
    print(f"Sending the Reapplication mail to {name} on mail id: {email}")
    ...
    try:
        ...
        message["From"] = sender
        message["Subject"] = f"Hey {name.title()}, volunteer with us again"
        message["To"] = email
