...
def lambda_handler(event, context):
    ...
    #Reading the Data - Giveindia
    df = pd.read_excel(secretsmanager_response["internship_completion_link"], sheet_name = "Giveindia")
    ...
    #Trigger "donor_send_mail" lambda
    if(len(df) > 0):
        print("People Found Today for Donor Mail")
